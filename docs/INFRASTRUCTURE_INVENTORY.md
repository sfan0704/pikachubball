...
| Yahoo Developer app | `PikachuBball - Local` (app ID `i19hJ8X4`) once freed by the prod move (CAR-74) | `PikachuBball` (`VZxFFbzH`), shared with prod | `PikachuBball` (`VZxFFbzH`); sign-in switching from `PikachuBball - Local` (`i19hJ8X4`), CAR-57 |
